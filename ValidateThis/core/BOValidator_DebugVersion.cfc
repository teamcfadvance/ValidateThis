...
<cfcomponent output="false" name="BOValidator" hint="I am a validator responsible for holding validation rules for a business object.">
	...
	<cffunction name="init" returnType="any" access="public" output="true" hint="I build a new BOValidator">
		...
		<cfoutput>
			definitionPath_PassedIn: #arguments.definitionPath#<br />
			objectType_PassedIn: #arguments.objectType#<br />
			definitionPath_FromValidateThisConfig: #arguments.ValidateThisConfig.definitionPath#<br />
			CheckDirectoryExists_FromValidateThisConfig: #variables.FileSystem.CheckDirectoryExists(arguments.ValidateThisConfig.definitionPath)#<br />
			ExpandPath_FromValidateThisConfig: #ExpandPath(arguments.ValidateThisConfig.definitionPath)#<br />
		</cfoutput>
		...
		<cfoutput>
			definitionPath_Calculated: #arguments.definitionPath#<br />
		</cfoutput>
		<cfabort>
