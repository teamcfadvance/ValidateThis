...
<option value="AX"<cfif (structKeyExists(s, fieldName) AND s[fieldName] IS "AX") OR (NOT structKeyExists(s, fieldName) AND def IS "AX")> selected="selected"</cfif>>�LAND ISLANDS</option>
...
<option value="CI"<cfif (structKeyExists(s, fieldName) AND s[fieldName] IS "CI") OR (NOT structKeyExists(s, fieldName) AND def IS "CI")> selected="selected"</cfif>>C�TE D'IVOIRE</option>
...
<option value="RE"<cfif (structKeyExists(s, fieldName) AND s[fieldName] IS "RE") OR (NOT structKeyExists(s, fieldName) AND def IS "RE")> selected="selected"</cfif>>R�UNION</option>
