...
<p>Welcome to the <strong>ValidateThis</strong> Validating a Structure Demo Page.
...
<p>All of the validations are driven by a simple xml file, which is used to define the business rules that apply.  You can view the xml file <a href="user.xml" target="_blank">here</a>.</p>
<p>The code for this demo integrates ValidateThis into the application via the ValidateThis service object, and uses ValidateThis to validate a strusture on the server-side, rather than an object.</p>
